...
l=setTimeout(T,t),g(u))}return void 0===l&&(l=setTimeout(T,t)),f}return t=j(t)||0,y(n)&&(s=!!n.leading,a=(m="maxWait"in n)?v(j(n.maxWait)||0,t):a,d="trailing"in n?!!n.trailing:d),S.cancel=function(){void 0!==l&&clearTimeout(l),c=0,i=u=o=l=void 0},S.flush=function(){return void 0===l?f:h(b())},S}(e,t,{leading:i,maxWait:t,trailing:o})};const O="feedback-form-state",T=document.querySelector(".feedback-form");(e=localStorage.getItem(O))&&Object.entries(e=JSON.parse(e)).forEach(([e,t])=>{T.elements[e].value=t??""}),T.addEventListener("submit",function(e){e.preventDefault();let{email:t,message:n}=e.currentTarget.elements;console.log({email:t.value,message:n.value}),localStorage.removeItem(O),e.currentTarget.reset()}),T.addEventListener("input",((t=i)&&t.__esModule?t.default:t)(function(e){let t=localStorage.getItem(O);t=t?JSON.parse(t):{};let{email:n,message:i}=T.elements;t={email:n.value.trim(),message:i.value.trim()},localStorage.setItem(O,JSON.stringify(t))},500));//# sourceMappingURL=03-feedback.bb1d94be.js.map

//# sourceMappingURL=03-feedback.bb1d94be.js.map
